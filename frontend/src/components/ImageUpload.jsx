...
<label htmlFor='file-upload'>
  <div className='cursor-pointer inline-flex items-center justify-center rounded-md border border-input bg-background px-4 py-2 text-sm font-medium hover:bg-accent hover:text-accent-foreground w-full'>
    Upload Images
  </div>
</label>
     {/* image preview */}
